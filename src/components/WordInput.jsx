    ...
    >
      ...
      <div className="font-light text-xl text-gray-700 space-y-2">
        ...
        {authors.map((author, index) => (
          <div key={index} className="font-bold py-2">
            {author}
          </div>
        ))}

        {/* Divider */}
        <div className="h-[1px] bg-gray-300 w-1/2 mx-auto my-4" />

        {/* Developer Entry - Same Style as Authors */}
        <div className="font-bold py-2">
          Amher Cosaine Timpahan
          <span className="block text-sm font-medium text-gray-500 mt-1 uppercase tracking-tighter">
