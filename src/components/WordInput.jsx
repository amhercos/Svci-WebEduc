...
function WordInput({ currentWord, setCurrentWord, onSubmit, onPlayClickSound }) {
  ...
  // Adding yourself with a professional title
  const developer = {
  ...
  {showCredits && (
    ...
    >
      ...
      >
        ...
        {/* Updated to match author text-lg, text-gray-800, and font-medium */}
        <div className="text-lg text-gray-800 font-medium">{developer.name}</div>
